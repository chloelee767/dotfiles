# NOTE: use .zprofile directly instead of having .zprofile call .profile,
# because some systems (eg. popos) will still run .profile under sh/bash (?)
# during login which will fail due to syntax differences.
