...
;; (package! bibtex-completion :recipe (:local-repo "/home/chloe/Code/org-ref/"))
;; (when (featurep! :completion ivy)
;;   (package! ivy-bibtex :recipe (:local-repo "/home/chloe/Code/org-ref/")))
;; (when (featurep! :completion helm)
;;   (package! helm-bibtex :recipe (:local-repo "/home/chloe/Code/org-ref/")))
