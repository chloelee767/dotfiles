;; doom-monokai-v2-theme.el --- Doom's Monokai Classic theme with minor tweaks -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-monokai-v2-theme nil
  "Options for doom-molokai."
  :group 'doom-themes)

;; (defcustom doom-monokai-v2-brighter-comments nil
;;   "If non-nil, comments will be highlighted in more vivid colors."
;;   :group 'doom-monokai-v2-theme
;;   :type 'boolean)

;; (defcustom doom-monokai-v2-comment-bg doom-monokai-v2-brighter-comments
;;   "If non-nil, comments will have a subtle, darker background. Enhancing their
;; legibility."
;;   :group 'doom-monokai-v2-theme
;;   :type 'boolean)

(defcustom doom-monokai-v2-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-monokai-v2
  ...
  ((bg         '("#272822" nil       nil          ))
   ...
   (-modeline-pad
    (when doom-monokai-v2-padded-modeline
      (if (integerp doom-monokai-v2-padded-modeline) doom-monokai-v2-padded-modeline 4)))
  ...
  ((lazy-highlight :background violet :foreground base0 :distant-foreground base0 :bold bold)
   ...
   (font-lock-doc-face
    ...
    :slant 'italic
    :weight 'bold) ;; differentiate doc comments from regular comments by making them bold
   (font-lock-type-face
    :foreground type
    :slant 'italic)
...
;;; doom-monokai-v2-theme.el ends here
